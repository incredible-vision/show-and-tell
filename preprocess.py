...
if __name__ == "__main__":
    ...
    parser.add_argument('--caption_json', default='/home/jisu/Desktop/Data/COCO/caption_datasets/dataset_coco.json', help='input json file to create vocabulary')
    ...
    # options
    parser.add_argument('--images_root', default='/home/jisu/Desktop/Data/COCO', help='root location in which images are stored, to be prepended to file_path in input json')
