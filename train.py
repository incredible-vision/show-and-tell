...
from models2 import ShowAttendTellModel
        ...
        for epoch in range(1, 1 + self.opt.max_epochs):
            ...
            for iter, (images, captions, lengths, coco_imgids) in enumerate(self.trainloader):
                ...
                if (total_iteration % self.opt.save_checkpoint_every == 0):
                    val_loss, predictions, lang_stats = evaluation(self.model, self.criterion, self.validloader, self.vocab, self.opt)
