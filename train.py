...
class Trainer(object):
    def __init__(self, opt, trainloader, validloader):
        ...
        self.model = ShowAttendTellModel_XE(opt.hidden_size, opt.embed_size, len(self.vocab), opt.embed_size, opt)
        #self.model = ShowAttendTellModel_XE(opt.embed_size, opt.hidden_size, len(self.vocab), 1)
